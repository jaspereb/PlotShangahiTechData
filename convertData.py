# This script reads in yolo ultralytics format data and converts it to shanghai tech style data.
# It will step through the yoloDataset folder 
# 
# search the dataToPlot folder for GT_*.mat files then try to find a matching .jpg file (same name) and plot the 
